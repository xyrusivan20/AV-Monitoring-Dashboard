        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {teamMembers.map(member => {
              ...
              return (
                // Added "group" class here to trigger animations on hover
              ...
              {coverages.slice(0, 8).map((cov, idx) => (
                <div key={idx} className="bg-slate-900 border border-slate-800 rounded-lg p-5 flex flex-col md:flex-row justify-between gap-4 hover:bg-slate-800/60 transition-colors">
                  ...
                  <div className="flex flex-col items-start md:items-end justify-center gap-3">
                    ...
                    {cov.gdrive && (
                      <a href={cov.gdrive} target="_blank" rel="noreferrer" className="text-[10px] text-blue-400 hover:text-blue-300 font-mono uppercase tracking-widest transition-colors flex items-center gap-1 bg-blue-500/10 hover:bg-blue-500/20 px-2 py-1 rounded">
                        ↗ GDrive Link
                      </a>
                    )}
                  </div>
